...
module.exports = Doc;
function Doc(connection, collection, id, isGraph) {
...
Doc.prototype.ingestSnapshot = function(snapshot, callback) {
  ...
  if (!this.isGraph && (this.type || this.hasWritePending())) {
...
Doc.prototype.create = function(data, type, source, callback) {
  ...
  if (this.type) {
    // emitting the error here will cause Racer/ShareDB to "get stuck". 
    // let's disable error emitthing for now and replace it with a console call.
