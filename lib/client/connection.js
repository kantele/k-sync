...
Connection.prototype.handleMessage = function(message) {
  ...
  switch (message.a) {
    ...
    case 'gop':
      var query = this.queries[message.id];
      if (query) query.handleGop(message);
      return;
...
Connection.prototype.createRPC = function(name, callback) {
  this.rpc[name] = new RPC(name, this, callback);
};

Connection.prototype._createQuery = function(action, collection, q, options, callback) {
  var id = this.nextQueryId++;
  var query = q && q.$g? new Graph(action, this, id, collection, q, options, callback) : new Query(action, this, id, collection, q, options, callback);
...
Connection.prototype.createFetchQuery = function(collection, q, options, callback) {
  return this._createQuery(q && q.$g? 'gf': 'qf', collection, q, options, callback);
};
...
Connection.prototype.createSubscribeQuery = function(collection, q, options, callback) {
  return this._createQuery(q && q.$g? 'gs': 'qs', collection, q, options, callback);
};
