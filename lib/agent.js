...
Agent.prototype.setEmitterIfExistingPathQuery = function(queryId, query, options) {
  var previous = this.subscribedQueries[queryId];
  var isPathQuery = Array.isArray(query);
  if (previous && isPathQuery) options.emitter = previous;
}
...
Agent.prototype._checkRequest = function(request) {
  if (request.a === 'qf' || request.a === 'qs' || request.a === 'qu' || request.a === 'gf' || request.a === 'gs' || request.a === 'gu') {
    // Query messages need an ID property.
    if (typeof request.id !== 'number') return 'Missing query ID';
  } else if (request.a === 'op' || request.a === 'gop' || request.a === 'f' || request.a === 's' || request.a === 'u') {
    // Doc-based request.
...
Agent.prototype._querySubscribe = function(queryId, collection, query, options, callback) {
  ...
  this.setEmitterIfExistingPathQuery(queryId, query, options);
